...
* The analysis required handling large raster and running the model a **Cloud server** (Hierarchical spatial model, very long to run)
...
* Even though data processing and analysis very complex, I tried to make the papers easy to understand
...
Links to [paper 1](https://www.sciencedirect.com/science/article/pii/S0006320719318312) and [paper 2](https://ecoevorxiv.org/2md94/download?format=pdf)
...
### Slides made with the R package **xaringan** and available on my [github](https://bencretois.github.io/my_work_presentation/#1)
