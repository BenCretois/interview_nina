...
### Managing, visualizing and analyzing data
...
* I am also running a [blog](https://benjamincretois.netlify.app/post/) where I try to explain simply complex statistical methodologies
...
* I learned how to use **Overleaf** (online LaTeX editor) to collaborate with statisticians
...
* I am currently planning to learn more about **image recognition algorithms** to work on a camera trap database
...
.RUred[I do not want to be completely detached from the research environment but rather .orange[help researchers do better research]]
